...
import { getFirestore, doc, setDoc, collection, onSnapshot, query } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-firestore.js";
...
function carregarUsuarios() {
    ...
    onSnapshot(q, (snapshot) => {
        ...
        snapshot.forEach((doc) => {
            ...
            li.textContent = `👤 ${dados.nomeCompleto} (@${dados.nomeUsuario})`;
            listaUl.appendChild(li);
        });

        if (snapshot.empty) {
            listaUl.innerHTML = "<li style='padding: 10px; color: #888;'>Nenhum usuário cadastrado.</li>";
        }
    });
}
